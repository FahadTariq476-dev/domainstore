...
Vvveb.Builder = {
	...
	_frameLoaded: function () {
		...
		self.frameHead.append('<script data-form-helpers src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>');
		self.frameHead.append('<script id="myScript"  data-form-helpers src="' + Vvveb.baseUrl + '../../temp/asset/main.js"></script>');
