...
<head>
    ...
    <title>Welcome To Domain Store</title>
    <!-- Favicon-->
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-pink hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <div class="number count-to" data-from="0" data-to="{{$no_domain}}" data-speed="15" data-fresh-interval="20"></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-cyan hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <div class="number count-to" data-from="0" data-to="{{$no_query}}" data-speed="1000" data-fresh-interval="20"></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-light-green hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <div class="number count-to" data-from="0" data-to="{{$no_reply_queries}}" data-speed="1000" data-fresh-interval="20"></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="card">
                        <div class="body bg-cyan">
                            <div class="m-b--35 font-bold">PLACEHOLDERS</div>
                            <ul class="dashboard-stat-list">
                                 @foreach($placeholders AS $i=>$placeholder)
                                <li>
                                    {{$i+1}}. {{$placeholder->variable_name}}
                                    <span class="pull-right">
                                        <p>{{$placeholder->variable_value}}</p>
                                    </span>
                                </li>
                                @endforeach
                                <!-- <li>
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="card">
                        <div class="body bg-teal">
                            <div class="font-bold m-b--35">Domains Queries</div>
                            <ul class="dashboard-stat-list">
