...
<head>
  ...
  <title>{{ isset($domain) ? strtr($domain[0]->url, array('http://' => '', 'https://'=>'', 'www'=> '')) : 'Template1'}} - Domain Store</title>
  ...
  <link href="{{asset('template2/css/coming-soon.min.css')}}" rel="stylesheet">
  <style>
...
<input type="hidden" value="{{isset($did) ? $did : '0'}}" id="did">
  ...
  <video playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop">
    <source src="{{asset('template2/mp4/bg.mp4')}}" type="video/mp4">
  </video>
      ...
      <div class="row h-100">
        <div class="col-12 my-auto">
          <div class="masthead-content text-white py-5 py-md-0">
            ...
            @if(!isset($form))
            <p class="mb-5">Your Sample Text with @paragraph placeholder variable goes here
              <strong>Aug 2020</strong>! Sign up for updates using the form below!</p>
            @endif
            </div>
          </div>
        </div>
  ...
  <script src="{{asset('template2/js/coming-soon.min.js')}}"></script>
